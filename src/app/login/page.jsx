        ...
        {/* container putih*/}
          <div className="flex flex-col h-full gap-4 py-5  w-11/12 md:w-1/4 bg-primary2 mx-auto rounded-lg px-4 ">
            <div className=" items-center content-center flex-col flex my-auto gap-6">
                ...
                {/* Provider Item */}
                <div className="w-3/5 border-black border-2 p-3 rounded-lg text-center flex flex-row gap-2 pl-6 divide-x cursor-pointer" onClick={() => signIn("google")}>
                    <Image src="/google.png" alt="" width={24} height={24} />   
                    <div className="pl-2">Google</div>
                </div>
                <div className="w-3/5 border-black border-2 p-3 rounded-lg flex flex-row gap-2 pl-6 divide-x cursor-pointer">
